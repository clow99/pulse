...
export const metadata: Metadata = {
  ...
  description:
    'Preview the expected Pulse self-hosting architecture, operational requirements, and read-only product demo.',
  alternates: {
    canonical: '/self-host',
  },
  openGraph: {
      ...
      <main id="main-content">
        ...
        <section className={styles.closing}>
          ...
          <div className={styles.closingContent}>
            ...
            <p>
              The public demo uses deterministic synthetic data and exposes only
              the Overview, Acquisition, and Uptime product views.
            </p>
            <div className={styles.actions}>
              <Link className={styles.primaryAction} href="/demo">
                Open the live demo
